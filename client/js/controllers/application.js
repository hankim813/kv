...
angular
    ...
    var answers = [
    	...
    	'In the weeks post-graduation (the second time around) I began the torturous thought process of <em>What am I going to do with my life?</em> It had been a plaguing question for at least six months, but now with the priorities of school behind me it was time that I provide an answer.<br><br>I was sitting in the computer room as the sunlight stealing through the blinds managed to swipe my focus as well. I was deep in existential thought:<br><br><strong><em>Life is a performance to procrastinate death.</em></strong><br><br>I was frustrated with the repetitive nature of each generation: Graduate high school, go to college, get a job, make money, have a family, have a funeral. Why is it the norm for us to do things simply because we’re supposed to? Where were the people who saw things as I did and how could they participate in this guise knowing it’s not real?<br><br>I needed a break from my pessimistic crisis, turning to the fictional world of Avatar the Last Airbender to uplift me once again. Then, the wise words of Uncle Iroh pulled me out of my void:<br><br>“<em>In the darkest times hope is something we give ourselves. That is the meaning of inner strength.</em>”<br><br>I immediately pressed pause. Perhaps there wasn’t room for people like to me to participate in the performance, but I had the ability to create my own role. If I hoped to make a real impact on people and bettering our way of life, I would have to start somewhere.<br><br>When I saw Everlane’s mission, I knew it would be the perfect first step.',
    	'<strong>Attention to detail</strong>— I’ve got it. For example, this specific question in the application online literally reads: “Why are you a perfect fit the Assistant Photo Producer role?”  This sentence is incorrect as it omits the word \'for.\'<br><br>Aside from complete sentences, I ensure that every project I work on is perfectly in line with my vision before delivering the final result. For example, this entire job application complete with box, resume, application answers, cover letter, and polaroids (all in both digital and print) has taken me about one full month to complete.<br><br>I’ve thought out every detail down to the tissue paper in the box or a specific word in a sentence to ensure each aspect presents the image I mean to convey. I’ve been working with a great friend – the kindly Asian man who delivered this very package to you – to be my second pair of eyes throughout the process and to create my beautiful website.<br><br>Our Skype sessions would be hours at a time; I had him move things pixel by pixel, test out at least four different fonts, and bold something here or italicize something there.<br><br>When he provided constructive feedback (cruel at times but helpful always) we would go through each sentence and deliberate extensively over the use of which word would fit best or what sentence structure projected my voice the most.<br><br>Although this can be incredibly tedious and at times discouraging, all of this arduous work will be worth it in the end (let\s hope!).<br><br>My completed project will be exactly as I envisioned it, or hopefully even better, and attention to detail is what pulled it all together.<br><br><strong>Communication</strong>—I do it. To me, this skill encompasses many others: how the person in question listens to, collaborates with, and motivates those communicated with. Everyone has the right to present ideas, and in turn, everyone should have the right to be heard. It is often difficult for people to feel comfortable doing so and that is why being communicative is crucial for creating an inclusive environment.<br><br>With that said, I prefer people to be frank as there’s no sense in beating around the bush when striving for efficiency and mutual trust. I admire fearlessness when it comes to sharing ideas. You have to start somewhere and even though your first idea might not be the best, it should never deter you from voicing your opinions.<br><br>In order to trust your team to provide the best results, everyone needs to be honest about their true thoughts. Obviously one should be mindful of the delivery of these thoughts so as not to diffuse the spirit.<br><br>Each colleague has the responsibility to keep the other going should they become discouraged. Of course I still have many more ways of communication to learn and still some to perfect, but with the tactics above I have a solid start to creating the best environment for my colleagues and myself.<br><br>And lastly the job description—I’m excited by it; <strong>passion</strong> always wins over practicality in my book. Everlane’s brand and mission is innovative and ethical. You embody a brand that I can truly believe in. I have been inspired time and time again by the website and social media alone. Because of this, I want to learn from the people who create and live by the image of Everlane. I want to be a part of shaping Everlane\'s future and the impact you will undoubtedly have on the fashion industry.'
    ];
